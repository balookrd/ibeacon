 ...
 *
 * Battery-optimisation exemption and exact-alarm access have real system
 * dialogs. Vendor autostart whitelists (MIUI, EMUI, ColorOS, FuntouchOS, One UI)
 * have no API at all — the best any app can do is open the right settings screen
 * and say plainly what needs to be switched on there.
 */
